...
Signature ok
subject=/C=RO/ST=Romania/L=Bucharest/O=Cmevo Digital SRL/OU=devops/CN=private-api.cmevo.com/emailAddress=contact@cmevo.com
...
Please enter the following 'extra' attributes
to be sent with your certificate request
A challenge password []:CLIENT_PASSWORD
An optional company name []:
```
